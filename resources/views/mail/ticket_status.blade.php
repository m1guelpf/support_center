...
<head>
  ...
  <title>Ticket #{{ $ticket->ticket_id }} opened</title>
    ...
    <td align="center" valign="top" width="100%" style="background-color: #f7f7f7;" class="content-padding">
      <center>
        <table cellspacing="0" cellpadding="0" width="600" class="w320">
          ...
          <tr>
            <td class="free-text">
              Your ticket #{{ $ticket->ticket_id }} has marked as {{ $ticket->status }}.
            </td>
          </tr>
          <tr>
            <td class="button">
              ...
              <![endif]--><a href="{{ url('tickets/'.$ticket->ticket_id) }}"
                      ...
                      <tr>
                        <td class="mini-block-padding">
                          <table cellspacing="0" cellpadding="0" width="100%" style="border-collapse:separate !important;">
                            <tr>
                              <td class="mini-block">
                                <span class="header-sm">Your details</span><br />
                                {{ ucfirst($user->name) }} <br />
                                {{ $user->email }} <br />
                                <br />
